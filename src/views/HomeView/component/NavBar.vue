...
<template>
  <nav class="nav-bar fixed py-4 lg:py-3 xl:py-4 z-50 w-full">
    <div class="container flex justify-between items-center gap-20">
      <!-- Brand Logo -->
      <div class="brand-logo w-18 lg:w-20 2xl:w-32">
        <RouterLink to="/">
      ...
      <div class="hidden md:flex items-center justify-between md:gap-10 xl:gap-20 3xl:gap-28 w-full">
